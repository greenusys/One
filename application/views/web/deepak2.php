       ...
       <div class="card-header border-0">
            ...
            ?>
              <div class="post_img row">
                ...
                <div class="col-md-6 p-3">
                  ...
                  if($ext=='mp4')
                  {?>
                  <a class="" href="<?=base_url('Post/viewPost/').$p_ost['post_id']?>"><video controls class="w-100">
                ...
                {?>
                  <a class="" href="<?=base_url('Post/viewPost/').$p_ost['post_id']?>"><img class="img img-fluid rounded d-block post_image" src="<?= $images ?>"></a>
                  <?php
                }
                  ?>
                </div>
        ...
        <div class=" comments_list border-top">
          ...
          <div class="row mt-2 px-2">
            <div class="col-md-1">
              <span> 
                <img class="rounded-circle like_img" src="<?=base_url()?>assets/img/Profile_Pic/<?=$p_ost['total_comments'][$i]->profile_picture?>">
              </span>  
            </div>
