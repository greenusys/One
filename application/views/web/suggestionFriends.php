		...
		<div class="col-md-10 ">
			<div class="">
				<div class="row profile-info-div bg-white shadow-sm p-2 w-75 m-auto">
				    <div class="col-sm-4">
					    <div>
						    <img src="<?=base_url()?>assets/img/Cover_Photo/cover5.jpg"  class="rounded-sm img-fluid">
						</div>
						 <img src="<?=base_url()?>assets/img/Profile_pic/profile8.jpg" class="rounded-circle img-fluid people-profile">
					</div>
					<div class="col-sm-5">
					    <a href="#"><h6 class="font-weight-bold text-info mt-2">Sonali Sona</h6></a>
				...
				<!-- 		<div class="dropdown_btn">
						 ...
						 <button type="button" class="btn btn-secondary mt-4" id="following" style="display:none"><span><i class="fa fa-check"></i> Following</button> -->
					<!-- 	<button type="button" class="btn btn-secondary mt-4" id="msg"><span><i class="fa fa-caret-down" style="font-size:22px"></i></span></button>  --> 
					</div>
				</div>
