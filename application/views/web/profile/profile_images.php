            ...
            <div class="row px-3 py-2 m-0 bg-white">
                <div class="col-md-8 p-2">
                    <h5 class="m-0 font-weight-bold"> 
                      ...
                      if($ProfileImages[0]->cover_path){ ?>
                       Cover Images
                     <?php }else{ ?> Profile Images 
                   <?php } ?>
                   </h5>
                </div>
                      ...
                      <div class="col-md-3 mt-2 p-1">
                        <div class="content">
                          <a href="<?=base_url('Post/viewPost/').$post->post_id?>" target="_blank">
                            ...
                            <img class="content-image" src="<?=base_url('assets/uploads/images/').$gallaryimg?>">
                            <div class="content-details fadeIn-bottom fadeIn-right">
                              <div class="">

                                <div class="float-left"><p><span><?=$post->total_likes?></span>  <i class="fa fa-heart " aria-hidden="true"></i></p></div>
                               

                                
                                <div class="float-right"><p><span><?=$post->total_comments?></span> <i class="fa fa-comment-o" aria-hidden="true"></i></p></div>
