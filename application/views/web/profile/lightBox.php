...
$.ajax({
    ...
    success:function(response){
        ...
        for(let i=0; i<response.album.length; i++){
            ...
            di+='    <div class="numbertext">'+i+' / '+response.album.length+'</div>';
            di+='    <img src="<?=base_url()?>'+response.album[i]+'" style="width:680px">';
            di+='</div>';


            var di_='';
            di_+='<div class="column">';
            di_+='<img class="demo" src="<?=base_url()?>'+response.album[i]+'" onclick="currentSlide('+i+')" alt="Nature">';
            di_+='</div>';
            $('#sli_').append(di);
            $('#img__').append(di_);
...
function showSlides(n) {
 ...
 <?php
    ...
    $i=1;
        ...
        # code...?>
         <div class="column">
            <img src="<?=base_url().$imgArr[0]?>" onclick="openModal(<?=$album->album_id?>);currentSlide(<?=$i?>)" class="hover-shadow">
        </div>
        <?php
        }
    ?>
